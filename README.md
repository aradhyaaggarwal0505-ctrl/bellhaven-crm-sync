...
## What the run found (46 proposals, all approved)
...
* Contacts: the website lists an administrator per community; the CRM has contacts. Same
  match/propose loop, not done here.
